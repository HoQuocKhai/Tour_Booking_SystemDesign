...
| Bước |             Tên bước              |                              Mô tả chi tiết hành vi người dùng                               |                          Hệ thống cần xử lý / phản hồi                           |
| :--: | :-------------------------------: | :------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
|  1   |        Truy cập trang chủ         |                            Người dùng vào trang vietravelasia.com                            | Tải giao diện, load banner, gợi ý tour nổi bật, set ngôn ngữ \+ tiền tệ mặc định |
|  2   |           Chọn danh mục           | Chọn “Tours & Activities”, “Hot Deals”, “Destinations”, “Tour Themes”, hoặc “Plan Your Trip” |                  Load trang danh mục tương ứng, hiển thị bộ lọc                  |
|  3   |        Lọc / tìm kiếm tour        |                           Lọc theo điểm đến, ngày, giá, loại tour                            |                   Hệ thống trả kết quả danh sách tour phù hợp                    |
|  4   |         Xem chi tiết tour         |                 User click 1 tour → xem lịch trình, hình ảnh, giá, khởi hành                 |            Hiển thị trang chi tiết; xử lý đổi ngôn ngữ/tiền tệ nếu có            |
|  5   |      Chọn thông tin đặt tour      |                           User chọn số lượng khách, ngày khởi hành                           |                    Hệ thống tính lại giá, kiểm tra slot trống                    |
|  6   |         Thêm vào giỏ hàng         |                                    User bấm “Add to cart”                                    |               Tour được thêm vào Cart, icon Cart cập nhật số lượng               |
|  7   |            Mở giỏ hàng            |                            Người dùng xem danh sách tour đã chọn                             |                Hệ thống hiển thị cart \+ tổng giá \+ nút checkout                |
|  8   | Login / Register (nếu chưa login) |              User login, đăng ký hoặc chọn checkout dưới dạng guest (nếu được)               |                         Xác thực người dùng, lưu session                         |
|  9   |     Nhập thông tin thanh toán     |                       Nhập tên, email, số điện thoại, yêu cầu đặc biệt                       |                      Validate dữ liệu, tính tổng cuối cùng                       |
|  10  |    Chọn phương thức thanh toán    |                      Ví dụ: thẻ, chuyển khoản, cổng thanh toán tích hợp                      |                    Kết nối cổng thanh toán, tạo order pending                    |
|  11  |         Xác nhận đặt tour         |                                 User nhấn “Confirm Booking”                                  |                    Hệ thống tạo booking → gửi email xác nhận                     |
|  12  |           Sau đặt tour            |                    User nhận email, xem lịch sử đơn hàng trong tài khoản                     |            Hệ thống cập nhật trạng thái booking, hỗ trợ đổi/chỉnh sửa            |
|  13  |        Hậu mãi & feedback         |                          Sau chuyến đi, user có thể để lại đánh giá                          |                   Hệ thống lưu đánh giá, hiển thị trên website                   |
...
|        Tính năng         |                             Mô tả                             |
| :----------------------: | :-----------------------------------------------------------: |
| **Đa ngôn ngữ (EN/VN)**  |   Chuyển ngôn ngữ ảnh hưởng đến toàn bộ UI và nội dung tour   |
| **Đa tiền tệ (USD/...)** |          Giá tour chuyển đổi theo tỷ giá hoặc preset          |
|     **Agent Login**      |    Đại lý đăng nhập để có giá đặc biệt hoặc quản lý khách     |
|   **Tailor-made Tour**   | Flow riêng: người dùng gửi yêu cầu → nhân viên tư vấn liên hệ |
